...
string Grafo::agmPRIM(int noNome) {
    ...
    bool sourceFound = procurarNoPeloNome(noNome);
    No *auxSourceNode = noAux;
    ...
    vectorEdgeSearch* vectorEdge = new vectorEdgeSearch( auxSourceNode, this );
    vectorEdgeSearch* solucao = new vectorEdgeSearch();

    EdgeInfo* auxEdgeSearch = vectorEdge->getMinimal( noNome );
    auxEdgeSearch->setBoth( true );
    solucao->insertEdgeSearch( auxEdgeSearch );
...
string Grafo::agmKRUSKAL() {
    ...
    vectorEdgeSearch* solucao = new vectorEdgeSearch();
    cout << "vetor criado\n";
    cout << vectorEdge->printVetor() << endl;
    EdgeInfo* auxEdgeSearch = vectorEdge->getMinimal();
    auxEdgeSearch->setBoth( true );
    solucao->insertEdgeSearch( auxEdgeSearch );
